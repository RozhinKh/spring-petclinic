 ...
 *
 * <h2>Overview</h2>
 * This package contains parsers for extracting metrics from different benchmark and
 * monitoring tools. Each parser converts tool-specific output formats into the unified
 * {@link org.springframework.samples.petclinic.metrics.NormalizedMetric} schema.
 *
 * <h2>Available Parsers</h2>
 *
 * <h3>JmhJsonParser</h3>
 * Parses Java Microbenchmark Harness (JMH) output in JSON format.
 * <ul>
 ...
 *   </ul>
 *   <li><b>Example fields</b>: primaryMetric.score, primaryMetric.scoreUnit, secondaryMetrics</li>
 * </ul>
 *
 * <h3>JfrMetricsParser</h3>
 * Parses Java Flight Recorder (JFR) metrics exported as JSON.
 * <ul>
 ...
 *   </ul>
 *   <li><b>Example fields</b>: gc.pause_time_avg_ms, threads.count, memory.heap_used_mb</li>
 * </ul>
 *
 * <h3>TestSuiteParser</h3>
 * Parses test suite results from JUnit XML and JaCoCo coverage reports.
 * <ul>
 ...
 *   </ul>
 *   <li><b>Example XML structure</b>: &lt;testsuite tests="100" failures="0" skipped="0" time="45.5"&gt;</li>
 * </ul>
 *
 * <h3>LoadTestParser</h3>
 * Parses load testing results (Apache JMeter, k6, Gatling, etc.).
 * <ul>
 ...
 *   </ul>
 *   <li><b>Example fields</b>: latency.p50_ms, throughput.requests_per_sec, errors.error_rate_percent</li>
 * </ul>
 *
 * <h3>ActuatorMetricsParser</h3>
 * Parses Spring Boot Actuator metrics endpoint output.
 * <ul>
 ...
 *   </ul>
 *   <li><b>Example fields</b>: http.request_count, jvm.memory.heap_used_mb, cache.hit_rate</li>
 * </ul>
 *
 * <h3>BlockingDetectionParser</h3>
 * Parses blocking detection analysis results (static and runtime).
 * <ul>
 ...
 * </ul>
 *
 * <h3>ModernizationMetricsParser</h3>
 * Parses modernization and code migration metrics.
 * <ul>
 *   <li><b>Input format</b>: Modernization metrics JSON</li>
 *   <li><b>Metrics extracted</b>:</li>
 *   <ul>
 *     <li>Lines of code: total, modified, new</li>
 *     <li>Construct counts: synchronized usage, lock usage, atomic operations, concurrent collections</li>
 *     <li>Virtual thread adoption: construct count, structured concurrency usage, executor usage, reactive usage</li>
 ...
 *
 * <h3>JMH JSON</h3>
 * Array of benchmark results with structure:
 * <pre>{@code
 * [
 *   {
 ...
 *
 * <h3>JFR Metrics</h3>
 * Object with top-level keys for different metric categories:
 * <pre>{@code
 * {
 *   "gc": {
 ...
 * Standard JUnit XML format with attributes on testsuite element:
 * <pre>{@code
 ...
 * Structured JSON with latency, throughput, and error sections:
 * <pre>{@code
 * {
 *   "latency": {
 *     "p50_ms": 12.5,
