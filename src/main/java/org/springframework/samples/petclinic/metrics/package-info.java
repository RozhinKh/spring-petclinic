 ...
 *
 * <h2>Overview</h2>
 * This package provides comprehensive metrics aggregation and comparison functionality for
 * analyzing benchmark results across multiple Java variants (Java 17, Java 21 Traditional,
 ...
 *   <li>{@link AggregatedMetric} - Aggregated statistics (avg, min, max, stdDev) per metric</li>
 ...
 * <ul>
 *   <li><b>benchmark-results.json</b> - Complete structured dataset with all metrics, variants, runs, and aggregated statistics</li>
 *   <li><b>benchmark-results.csv</b> - Flat spreadsheet format with one row per metric, all variants in columns</li>
 *   <li><b>benchmark-summary.json</b> - Executive summary with 15-20 key metrics suitable for leadership review</li>
 * </ul>
 *
 * <h2>Usage Example</h2>
 *
 ...
 *   <li>category: String (startup, latency, throughput, memory, gc, threading, blocking, test_suite, modernization)</li>
 *   <li>data_source: String (jmh, jfr, test_suite, load_test, actuator, blocking, modernization)</li>
 * </ul>
 *
 ...
 * </pre>
 *
 * Variance is shown in parentheses as ±stdDev
 * Deltas calculated as: ((variant_value - baseline_value) / baseline_value) * 100
 *
